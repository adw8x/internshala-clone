            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={t("internship.categoryPlaceholder")}
                />
              </div>
              {/* Location Filter */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {t("internship.filterLocation")}
                </label>
                <input
                  type="text"
                  name="location"
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  <span>{t("internship.stipendMin")}</span>
                  <span>{t("internship.stipendMid")}</span>
                  <span>{t("internship.stipendMax")}</span>
                </div>
              </div>
            </div>
          </div>
          <div className="flex-1">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
              <p className="text-center font-medium text-black">
                {t("internship.internshipsFound", { count: filteredInternships.length })}
              </p>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <div>
                        <p className="text-sm font-medium">{t("internship.locationLabel")}</p>
