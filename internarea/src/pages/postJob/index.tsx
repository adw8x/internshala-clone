...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    if (hasemptyfields) {
      toast.error(t("postJob.fillAllDetails"));
      return;
    }
    try {
      setisloading(true);
      const res = await api.post("/job", formData);
      toast.success(t("postJob.posted"));
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900">{t("postJob.title")}</h1>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  placeholder={t("postJob.experiencePlaceholder")}
                />
              </div>
