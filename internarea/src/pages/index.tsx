...
export default function SvgSlider() {
  ...
  const stats = [
    ...
    { number: "10K+", label: t("home.newOpenings") },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-10">
        <h3 className="text-xl font-semibold mb-4 text-black">{t("home.popularCategories")}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-10">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-black">{t("home.latestInternships")}</h3>
          <Link
            href="/internship"
      ...
      <div className="max-w-7xl mx-auto px-4 pb-16">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold text-black">{t("home.latestJobs")}</h3>
          <Link
            href="/job"
            className="text-blue-600 flex items-center gap-1 text-sm"
          >
