            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handlefilterchange}
                  className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-700"
                  placeholder={t("job.experiencePlaceholder")}
                />
              </div>
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  <span>{t("job.salaryMin")}</span>
                  <span>{t("job.salaryMid")}</span>
                  <span>{t("job.salaryMax")}</span>
                </div>
              </div>
            </div>
          </div>
          <div className="flex-1">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
              <p className="text-center font-medium text-black">
                {t("job.jobsFound", { count: filteredjob.length })}
              </p>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <div>
                        <p className="text-sm font-medium">{t("job.categoryLabel")}</p>
                    ...
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <div>
                        <p className="text-sm font-medium">{t("job.locationLabel")}</p>
